...
namespace Ecommer.cms.admin.SanPham.QuanLySanPham
{
    public partial class SanPham_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = Rikai_Ecommer.SanPham.Thongtin_Sanpham_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = Rikai_Ecommer.NhomSanPham.Thongtin_Nhomsp();
            ddlNhom.Items.Clear();
        ...
        {
            DataTable dt = new DataTable();
            dt = Rikai_Ecommer.DanhMuc.Thongtin_Danhmuc_by_MaDMCha("0");
        ...
        {
            DataTable dt = new DataTable();
            dt = Rikai_Ecommer.DanhMuc.Thongtin_Danhmuc_by_MaDMCha(MaDMCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                Rikai_Ecommer.SanPham.Sanpham_Inser(tbTenSanPham.Text, ddlMau.SelectedValue, ddlSize.SelectedValue, ddlChatLieu.SelectedValue, flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text, tbNgayTao.Text, tbNgayHuy.Text, ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
            ...
            else
            {
                ...
                Rikai_Ecommer.SanPham.Sanpham_Update(id, tbTenSanPham.Text, ddlMau.SelectedValue, ddlSize.SelectedValue, ddlChatLieu.SelectedValue, tenAnhDaiDien, tbSoLuong.Text, tbGiaBan.Text, "",//tbMoTa.Text
