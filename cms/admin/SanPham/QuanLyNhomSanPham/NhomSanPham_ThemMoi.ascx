<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomSanPham_ThemMoi.ascx.cs" Inherits="Ecommer.cms.admin.SanPham.QuanLyNhomSanPham.NhomSanPham_ThemMoi" %>
<div class="head">
