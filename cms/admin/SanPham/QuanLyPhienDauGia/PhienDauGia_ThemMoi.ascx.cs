    ...
    public partial class PhienDauGia_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = Rikai_Ecommer.PhienDauGia.Thongtin_PhienDauGia_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                Rikai_Ecommer.PhienDauGia.PhienDauGia_Inser(tbThoiGianBatDau.Text, tbThoiGianKetThuc.Text, tbMaSP.Text, tbGiaDeXuat.Text, "");
            ...
            else
            {
                ...
                Rikai_Ecommer.PhienDauGia.PhienDauGia_Update(id, tbThoiGianBatDau.Text, tbThoiGianKetThuc.Text, tbMaSP.Text, tbGiaDeXuat.Text);
