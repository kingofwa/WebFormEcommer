<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhienDauGia_ChiTiet.ascx.cs" Inherits="Ecommer.cms.admin.SanPham.QuanLyPhienDauGia.PhienDauGia_ChiTiet" %>
