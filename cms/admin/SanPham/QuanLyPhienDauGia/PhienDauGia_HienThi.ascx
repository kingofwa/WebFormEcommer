<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhienDauGia_HienThi.ascx.cs" Inherits="Ecommer.cms.admin.SanPham.QuanLyPhienDauGia.PhienDauGia_HienThi" %>
<div class="head">
