...
namespace Ecommer.cms.admin.SanPham.QuanLyPhienDauGia.Ajax
{
    public partial class PhienDauGia : System.Web.UI.Page
    {
        string thaotac = "";
        ...
        private void XoaPhienDauGia()
        {
            ...
            if (Request.Params["id"] != null)
            {
                ...
                //Thực hiện code xóa          
                Rikai_Ecommer.PhienDauGia.PhienDauGia_Delete(id);
