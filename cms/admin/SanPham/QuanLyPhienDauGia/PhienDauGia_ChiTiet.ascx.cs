...
";
        ...
        {
            DataTable dt = Rikai_Ecommer.KhachHang.Thongtin_Khachhang_by_makh(MaKH);
            if (dt.Rows.Count > 0)
            {
...
";
        ...
        {
            DataTable dt = Rikai_Ecommer.PhienDauGia.Thongtin_PhienDauGia_by_id(id);
            if (dt.Rows.Count > 0)
            {
...
";
        ...
        private string LayThongTinSanPham(string MaSP)
        {
            ...
            DataTable dt = Rikai_Ecommer.SanPham.Thongtin_Sanpham_by_id(MaSP);
            if (dt.Rows.Count > 0)
            {
