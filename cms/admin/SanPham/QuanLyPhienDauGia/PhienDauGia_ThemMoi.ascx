<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhienDauGia_ThemMoi.ascx.cs" Inherits="Ecommer.cms.admin.SanPham.QuanLyPhienDauGia.PhienDauGia_ThemMoi" %>
<div class="head">
