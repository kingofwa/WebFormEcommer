<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachQuangCao_ThemMoi.ascx.cs" Inherits="Ecommer.cms.admin.QuangCao.QuanLyDanhSachQuangCao.DanhSachQuangCao_ThemMoi" %>
<div class="head">
