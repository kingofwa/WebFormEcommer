...
namespace Ecommer.cms.admin.QuangCao.QuanLyDanhSachQuangCao
{
    public partial class DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = Rikai_Ecommer.QuangCao.Thongtin_Quangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = Rikai_Ecommer.NhomQuangCao.Thongtin_Nhomquangcao();
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                Rikai_Ecommer.QuangCao.Quangcao_Inser(
            ...
            else
            {
                ...
                Rikai_Ecommer.QuangCao.Quangcao_Update(
