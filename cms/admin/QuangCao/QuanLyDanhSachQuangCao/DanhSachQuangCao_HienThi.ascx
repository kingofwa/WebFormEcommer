<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachQuangCao_HienThi.ascx.cs" Inherits="Ecommer.cms.admin.QuangCao.QuanLyDanhSachQuangCao.DanhSachQuangCao_HienThi" %>
<div class="head">
