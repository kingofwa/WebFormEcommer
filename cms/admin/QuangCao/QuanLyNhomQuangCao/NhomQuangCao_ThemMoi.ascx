<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_ThemMoi.ascx.cs" Inherits="Ecommer.cms.admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_ThemMoi" %>
<div class="head">
