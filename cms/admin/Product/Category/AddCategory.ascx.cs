using Ecommer.cms.App_Code.Database;
using System;
    ...
    public partial class AddCategory : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (handle == "Edit")
            {
                ...
                dt = Rikai_Ecommer.DanhMuc.Thongtin_Danhmuc_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (handle == "CreateNew")
            {
                ...
                Rikai_Ecommer.DanhMuc.Danhmuc_Inser(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
                ...
                else
                {
                    ...
                    Response.Redirect("Admin.aspx?modul=Product&submodul=Category");
                }
                #endregion
            }
            else
            {
                ...
                Rikai_Ecommer.DanhMuc.Danhmuc_Update(id, tbTenDanhMuc.Text, tenAnhDaiDien, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
