<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddCategory.ascx.cs" Inherits="Ecommer.cms.admin.Product.Category.AddCategory" %>
...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            ...
            <asp:Button ID="btThemMoi" runat="server" Text="Thêm mới" Class="btThemMoi" OnClick="btThemMoi_Click" />
            <asp:Button ID="btHuy" runat="server" Text="Hủy" Class="btHuy" />
        </div>
    </div>
</div>
