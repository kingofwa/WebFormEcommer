<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachTinTuc_ThemMoi.ascx.cs" Inherits="Ecommer.cms.admin.TinTuc.DanhSachTinTuc.DanhSachTinTuc_ThemMoi" %>
