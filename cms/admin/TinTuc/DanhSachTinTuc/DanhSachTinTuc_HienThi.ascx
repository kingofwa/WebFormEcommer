<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachTinTuc_HienThi.ascx.cs" Inherits="Ecommer.cms.admin.TinTuc.DanhSachTinTuc.DanhSachTinTuc_HienThi" %>
<div class="head">
    Các tin đã tạo 
