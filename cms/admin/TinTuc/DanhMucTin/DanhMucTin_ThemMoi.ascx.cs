...
namespace Ecommer.cms.admin.TinTuc.DanhMucTin
{
    public partial class DanhMucTin_ThemMoi : System.Web.UI.UserControl
    {
        ...
        {
            DataTable dt = new DataTable();
            dt = Rikai_Ecommer.DanhMucTin.Thongtin_DanhmucTin_by_MaDMCha(MaDMCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                Rikai_Ecommer.DanhMucTin.DanhmucTin_Inser(tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue, "");
            ...
            else
            {
                ...
                Rikai_Ecommer.DanhMucTin.DanhmucTin_Update(id, tbTenDanhMuc.Text, flAnhDaiDien.FileName, tbThuTu.Text, ddlDanhMucCha.SelectedValue);
